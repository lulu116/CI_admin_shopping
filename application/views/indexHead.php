    ...
    <div class="navbar-inner">
        <div class="container-fluid">
            ...
            <a class="brand" href="index.html">
                <img src="<?php echo base_url()?>img/logo.png" alt="Metro Lab" />
            </a>
            <!-- END LOGO -->
...
<div class="sidebar-scroll">
    <div id="sidebar" class="nav-collapse collapse">
        ...
        <ul class="sidebar-menu">
            <li class="sub-menu">
                <a class="" href="<?php echo site_url('welcomeController')?>">
                    <i class="icon-dashboard"></i>
                    <span>欢迎来到后台</span>
                </a>
            </li>
            <li class="sub-menu active">
                <a href="<?php echo site_url('indexController')?>" class="">
                    <i class="icon-th"></i>
                    <span>商品管理</span>
                    <span class="arrow"></span>
                </a>
                <ul class="sub">
                    <li class="active"><a class="" href="<?php echo site_url('addShopController')?>">商品添加</a></li>
                    <li><a  href="<?php echo site_url("showShopController")?>">商品修改</a></li>
                    <li><a class="" href="<?php echo site_url('showShopController')?>">商品展示</a></li>
                </ul>
            </li>
